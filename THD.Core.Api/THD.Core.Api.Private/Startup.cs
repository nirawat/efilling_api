...
namespace THD.Core.Api.Private
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped(typeof(IDocMenuHomeService), typeof(DocMenuHomeService));
            services.AddScoped(typeof(IDocMenuAService), typeof(DocMenuAService));
            services.AddScoped(typeof(IDocMenuBService), typeof(DocMenuBService));
            services.AddScoped(typeof(IDocMenuCService), typeof(DocMenuCService));
            services.AddScoped(typeof(IDocMenuDService), typeof(DocMenuDService));
